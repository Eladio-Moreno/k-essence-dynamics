/** 
Esto es una modificación de hiclass para incormporar el modelo de Scherrer agregando un potencial exponencial.

Comenzamos incluyendo las nuevas variables que necesitaremos.

Después de cada modificación pondremos 'mdfy'  
**/
...
//   enum gravity_model_subclass gravity_submodel_smg; /** Horndeski model */
  ...
  //mdfy. Aquí definimos las varaibles que utilizaremos en el modelo de Scherrer con potencial
...
/** Agregamos la variable Y que aparece en el modelo de Scherrer en el background y comentamos index_bg_prime_smg ya que ahora tnedremso una ecuación diferencial para Y y no de phi'' **/

  int index_bg_phi_smg;       /**< scalar field value */
  int index_bg_y_sch_smg;     /** < componete Y que aparece en K-G. mdfy **/
  ...
  /**Ahora vamos a definir nuestra variable Y que se va integrar ya que Y aparece en la ecuación de K-G. Nuevamente comentamos index_bi_phi_prime_smg. **/

  int index_bi_phi_smg;   /**< scalar field */
  int index_bi_y_sch_smg; /**< variable Y de la ec. de K-G. mdfy **/
