...
cdef class Class:
    ...
    def get_current_derived_parameters(self, names):
        ...
        for name in names:
            ...
            #mdfy
            #elif name == 'x0_schm':
             #   value = self.ba.x0_schm
            #elif name == 'f0_schm':
            #    value = self.ba.f0_schm
            #elif name == 'f2_schm':
             #   value = self.ba.f2_schm
            #elif name == 'theta_schm':
            #    value = self.ba.theta_schm
            #elif name == 'DM_schm':
            #    value = self.ba.DM_schm
            #elif name == 'h_schm':
            #    value = self.ba.h_schm
            #elif name == 'V0_schm':
            #    value = self.ba.V0_schm
            #elif name == 'lambda_schm':
            #    value = self.ba.lambda_schm
